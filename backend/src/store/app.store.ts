...
const orders: Order[] = [
  {
    ...
    assignedCopyShopId: "b6378b10-6fcb-4a43-8d54-870d540d0b65",
    assignedCopyShopName: "Basement Print Center",
    assignedCopyShopLocationNote: "Basement Kampus, dekat lift utama",
